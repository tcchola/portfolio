    ...
    let fns = parseVariantFormatString(variant).map((str)=>{
        ...
        return ({ wrap })=>{
            ...
            return wrap(_postcss.default.atRule({
                name,
                params: (_params_trim = (_params = params) === null || _params === void 0 ? void 0 : _params.trim()) !== null && _params_trim !== void 0 ? _params_trim : ''
            }));
        };
    }).reverse();
    return (api)=>{
 ...
 */ function buildPluginApi(tailwindConfig, context, { variantList, variantMap, offsets, classList }) {
     ...
     */ addDefaults (group, declarations) {
        ...
        matchVariant (variant, variantFn, options) {
            ...
            let id = (_options_id = (_options = options) === null || _options === void 0 ? void 0 : _options.id) !== null && _options_id !== void 0 ? _options_id : ++variantIdentifier;
            let isSpecial = variant === '@';
            var _options_values;
            for (let [key, value] of Object.entries((_options_values = (_options1 = options) === null || _options1 === void 0 ? void 0 : _options1.values) !== null && _options_values !== void 0 ? _options_values : {})){
                if (key === 'DEFAULT') continue;
                api.addVariant(isSpecial ? `${variant}${key}` : `${variant}-${key}`, ({ args, container })=>{
                    var _args;
                    return variantFn(value, {
                        modifier: (_args = args) === null || _args === void 0 ? void 0 : _args.modifier,
                        container
                    });
                }, {
                    ...options,
            ...
            let hasDefault = 'DEFAULT' in ((_options_values1 = (_options2 = options) === null || _options2 === void 0 ? void 0 : _options2.values) !== null && _options_values1 !== void 0 ? _options_values1 : {});
            api.addVariant(variant, ({ args, container })=>{
                var _args, _args1, // (JetBrains) plugins.
                _args2, _args3;
                if (((_args = args) === null || _args === void 0 ? void 0 : _args.value) === _sharedState.NONE && !hasDefault) {
                    return null;
                }
                var _args_value;
                return variantFn(((_args1 = args) === null || _args1 === void 0 ? void 0 : _args1.value) === _sharedState.NONE ? options.values.DEFAULT : (_args_value = (_args2 = args) === null || _args2 === void 0 ? void 0 : _args2.value) !== null && _args_value !== void 0 ? _args_value : typeof args === 'string' ? args : '', {
                    modifier: (_args3 = args) === null || _args3 === void 0 ? void 0 : _args3.modifier,
                    container
                });
            }, {
                ...options,
...
function registerPlugins(plugins, context) {
    ...
    for (let plugin of plugins){
        if (Array.isArray(plugin)) {
            ...
            var _plugin;
            (_plugin = plugin) === null || _plugin === void 0 ? void 0 : _plugin(pluginApi);
        }
    }
        ...
        if (checks.length > 0) {
            ...
            for (let util of classList){
                let utils = Array.isArray(util) ? (()=>{
                    ...
                    var _options_values;
                    let values = Object.keys((_options_values = (_options = options) === null || _options === void 0 ? void 0 : _options.values) !== null && _options_values !== void 0 ? _options_values : {});
                    let classes = values.map((value)=>(0, _nameClass.formatClass)(utilName, value));
                    if ((_options1 = options) === null || _options1 === void 0 ? void 0 : _options1.supportsNegativeValues) {
                    ...
                    if (checkImportantUtils && ((_options2 = options) === null || _options2 === void 0 ? void 0 : _options2.respectImportant)) {
                        classes = [
                            ...classes,
                            ...classes.map((cls)=>'!' + cls)
                        ];
    ...
    context.getClassList = function getClassList(options = {}) {
        ...
        for (let util of classList){
            if (Array.isArray(util)) {
                var _utilOptions, _utilOptions_types, _utilOptions1, _utilOptions2;
                let [utilName, utilOptions] = util;
                let negativeClasses = [];
                var _utilOptions_modifiers;
                let modifiers = Object.keys((_utilOptions_modifiers = (_utilOptions = utilOptions) === null || _utilOptions === void 0 ? void 0 : _utilOptions.modifiers) !== null && _utilOptions_modifiers !== void 0 ? _utilOptions_modifiers : {});
                if ((_utilOptions1 = utilOptions) === null || _utilOptions1 === void 0 ? void 0 : (_utilOptions_types = _utilOptions1.types) === null || _utilOptions_types === void 0 ? void 0 : _utilOptions_types.some(({ type })=>type === 'color')) {
                ...
                for (let [key, value] of Object.entries((_utilOptions_values = (_utilOptions2 = utilOptions) === null || _utilOptions2 === void 0 ? void 0 : _utilOptions2.values) !== null && _utilOptions_values !== void 0 ? _utilOptions_values : {})){
                    var _utilOptions3;
                    ...
                    if (((_utilOptions3 = utilOptions) === null || _utilOptions3 === void 0 ? void 0 : _utilOptions3.supportsNegativeValues) && (0, _negateValue.default)(value)) {
                        let cls = (0, _nameClass.formatClass)(utilName, `-${key}`);
