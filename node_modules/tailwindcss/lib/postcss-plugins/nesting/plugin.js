...
function nesting(opts = _postcssnested.default) {
    return (root, result)=>{
        ...
        let plugin = (()=>{
            var _opts_hasOwnProperty, _opts;
            if (typeof opts === 'function' || typeof opts === 'object' && ((_opts = opts) === null || _opts === void 0 ? void 0 : (_opts_hasOwnProperty = _opts.hasOwnProperty) === null || _opts_hasOwnProperty === void 0 ? void 0 : _opts_hasOwnProperty.call(_opts, 'postcssPlugin'))) {
                return opts;
            }
